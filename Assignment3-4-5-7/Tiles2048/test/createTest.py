...
# Testing encryption because Umphress ran a test and it received an error from the Sha256
    def test_create_ReturnSha256(self):
        userParms = {'op': 'create'}
        actualResult = create._create(userParms)
        expectedResult = '77D86464C5F53D5106E39B19846E69FB3994FD3BDA80F5F92D378531486D7F83'
